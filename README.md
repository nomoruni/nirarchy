...
allow/deny ports, delete rules directly from the bar) and ProtonVPN manager
(connect/disconnect, view server info). The UFW manager uses sudo to change
rules and optionally adds a passwordless sudoers rule.
