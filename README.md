...
| **Theming** | 8 themes (Tokyo Night default, Catppuccin, Everforest, Rose Pine, Gruvbox, Nord, Kanagawa, Osaka Jade) — one switch recolors the bar, foot terminals (even running ones), window borders, walker, mako, swayosd, lock screen and wallpaper, live |
...
```bash
git clone https://github.com/YOUR-USERNAME/nirarchy.git
cd nirarchy
bash install.sh
```
